...
.controller('accountCtrl', function ($scope, $state, $stateParams, AccountsFactory, SelectAccountServices) {
    ...
    $scope.saveAccount = function () {
        ...
        // Format date
        var dtTran = moment(SelectAccountServices.dateSelected, 'MMMM D, YYYY').valueOf();
...
.controller('selectAccountDateCtrl', function ($scope, $ionicHistory, SelectAccountServices) {

    if (typeof SelectAccountServices.dateSelected !== 'undefined' && SelectAccountServices.dateSelected !== '') {
        $scope.myDate = moment(SelectAccountServices.dateSelected, 'MMMM D, YYYY').format('YYYY-MM-DD');
    }
    $scope.dateChanged = function (transDate) {
        transDate = moment(transDate, 'YYYY-MM-DD').format('MMMM D, YYYY');
        SelectAccountServices.updateDate(transDate);
        $ionicHistory.goBack();
    };
...
.controller('pickTransactionTypeCtrl', function ($scope, $ionicHistory, PickTransactionServices) {
...
.controller('pickTransactionAccountFromCtrl', function ($scope, $ionicHistory, AccountsFactory, PickTransactionServices) {
    //
    // Get accounts
    //
...
.controller('pickTransactionAccountToCtrl', function ($scope, $ionicHistory, AccountsFactory, PickTransactionServices) {
    //
    // Get accounts
    //
    $scope.TransactionAccountList = AccountsFactory.getAccounts();
...
.controller('pickTransactionPayeeCtrl', function ($scope, $ionicHistory, PayeesFactory, PayeesService, PickTransactionServices) {
...
.controller('pickTransactionCategoryCtrl', function ($scope, $state, $ionicHistory, CategoriesFactory, PickTransactionServices, PickCategoryTypeService, PickParentCategoryService) {
    //
...
.controller('pickParentCategoryCtrl', function ($scope, $state, $ionicHistory, CategoriesFactory, PickParentCategoryService, PickCategoryTypeService) {
...
.controller('pickCategoryTypeCtrl', function ($scope, $state, $ionicHistory, PickCategoryTypeService) {
...
.controller('pickTransactionAmountCtrl', function ($scope, $ionicHistory, PickTransactionServices) {
...
.controller('pickTransactionDateCtrl', function ($scope, $ionicHistory, PickTransactionServices) {
...
.controller('pickTransactionNoteCtrl', function ($scope, $ionicHistory, PickTransactionServices) {
...
.controller('transactionCtrl', function ($scope, $state, $stateParams, $ionicHistory, AccountsFactory, PickTransactionServices, PayeesService, myCache, CurrentUserService) {
